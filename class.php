...
<div class="divider">
  ...
  <div>
    <h3 style="font-size:1.5rem">YouTube를 기반으로 유익하고 재미있는 교육/학습 콘텐츠를 제공하는 강의 사업을 진행합니다.</h3>
  </div>


  <div>
    <p>오리지널 채널 운영과 파트너 채널 매니지먼트를 통해 확보한 리소스를 바탕으로 유튜버에서 강사로의 확장 뿐만 아니라,<br>
      성장 가능성이 있는 외부 강사들을 YouTube로 진출시켜 학습을 위한 콘텐츠를 제공함으로써 온라인 교육 콘텐츠 시장을 선도하는 기업이 되고자 합니다.
    </p>
    <p>
      자체 강의 큐레이션 채널인 <유니브클래스>를 운영하며, 해당 채널을 통해 다양한 강의 콘텐츠를 YouTube Membership 기능을 통해 합리적인 가격에 제공합니다.
    </p>
  </div>
